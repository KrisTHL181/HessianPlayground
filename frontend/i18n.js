...
const I18N = {
    en: {
        ...
        'btn.natural_gradient': 'Natural Gradient',
        ...
        'label.ntk_samples': 'Max Samples (NTK / Fisher)',
        ...
        'plot.natural_gradient_step': 'Natural Gradient Step',
        ...
        'log.computing_natural_gradient': 'Solving natural gradient step...',
        'log.natural_gradient_result': 'Natural gradient: loss {loss_before} → {loss_after} (Δ={loss_improvement})',
        'log.natural_gradient_error': 'Natural gradient error: {message}',
        ...
        'log.computing_fisher': 'Computing Fisher (samples={samples})...',
        'log.fisher_computed': 'Fisher computed: method={method}, samples={samples}, mem≈{memory_mb}MB',
    ...
    zh: {
        ...
        'label.ntk_samples': '最大样本数 (NTK / Fisher)',
        ...
        'plot.natural_gradient_step': '自然梯度步',
        'plot.loss': '损失',
        'plot.accuracy': '正确率 %',
        'plot.step': '训练步',
        ...
        'log.computing_natural_gradient': '正在求解自然梯度步...',
        'log.natural_gradient_result': '自然梯度: 损失 {loss_before} → {loss_after} (Δ={loss_improvement})',
        'log.natural_gradient_error': '自然梯度错误: {message}',
        ...
        'log.computing_fisher': '正在计算 Fisher (样本数={samples})...',
        'log.fisher_computed': 'Fisher 计算完成: 方法={method}, 样本数={samples}, 内存≈{memory_mb}MB',
