...
# NTK computation
NTK_MAX_SAMPLES = 32
NTK_DISPLAY_MAX_SIZE = 200

# Hessian approximation methods
KFAC_MIN_LAYER_PARAMS = 2
KFAC_EIGENVALUES_MAX = 2000
BLOCK_DIAG_MIN_BLOCK_SIZE = 2
BLOCK_DIAG_MAX_BLOCK_SIZE = 5000
...
_RUNTIME_CONFIG_KEYS = {
    ...
    "DEFAULT_STEP_SCALE",
    "KFAC_EIGENVALUES_MAX",
    "BLOCK_DIAG_MIN_BLOCK_SIZE",
    "BLOCK_DIAG_MAX_BLOCK_SIZE",
    "CG_MAX_ITERATIONS",
    "CG_TOLERANCE",
    "NTK_MAX_SAMPLES",
    "NTK_DISPLAY_MAX_SIZE",
    "DEVICE",
    "REMOTE_ENABLED",
    "REMOTE_HOST",
    "REMOTE_PORT",
